...
let db;
// establish a connection to IndexedDB database and set version to 1
const request = indexedDB.open("pizza_hunt", 1);

// this event will emit if database version changes (nonexistent to v1, v1 to v2, etc.)
...
// upon successful request/interaction with database:
...
// this will execute if we attempt to submit a new pizza w/o internet connection
